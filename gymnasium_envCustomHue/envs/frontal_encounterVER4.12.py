...
# TODO: Important this custom env is based on aligned, unaligned top-bottom, unaligned bottom-top with scable width and valid range is larger, cover all cases that could happedn in this scenrario
